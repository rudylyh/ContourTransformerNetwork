...
from Models.Encoder import stackedhourglassmodule as M
...
class StackedHourGlass(nn.Module):
    ...
    def __init__(self, nChannels=256, nStack=2, nModules=2, numReductions=4, nJoints=16,
                 encoder_final_dim=256,
                 gcn_in_dim=256,
                 opts=None
                 ):
    ...
    def pregcn_cnn(self, feature):
        return feature.permute(0, 2, 3, 1).view(-1, self.opts['grid_size_encoder']**2, self.encoder_final_dim)

    def reload(self, path):
        print('Reloading StackedHourGlass...')
